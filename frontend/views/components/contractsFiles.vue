...
<div class="lds-css ng-scope"><div style="width:100%;height:100%" class="lds-rolling"><div></div></div></div>
 <div class="willPrintContract d-none" id="willPrintContract">
        ...
        <ol start="5" type="a">
        <li>
        <p align="JUSTIFY"><span style="font-family: Arial, serif;"><span style="font-size: small;">Que mediante escritura p&uacute;blica n&uacute;mero </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">___</span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"> de fecha </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">_____</span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"> otorgada ante la fe del Lic. </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">_____</span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"> titular de la notar&iacute;a pública número </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">___</span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"> del estado de </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">____</span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">, adquiri&oacute; la propiedad del bien inmueble identificado como </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">___________________________</span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">, en lo sucesivo referido como </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><strong>&ldquo;EL TERRENO&rdquo;</strong></span></span></p>
        </li>
        </ol>
        <p align="JUSTIFY">&nbsp;</p>
        <ol start="6" type="a">
        <li>
        <p align="JUSTIFY"><span style="font-family: Arial, serif;"><span style="font-size: small;">Que en EL TERRENO, est&aacute; llevando a cabo la construcci&oacute;n y desarrollo de un proyecto inmobiliario, que se sujetar&aacute; al régimen de propiedad en condominio, y estar&aacute; integrado por </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">

          <span class="information">{{ getDeps }}</span>

          </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"> unidades habitacionales y </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">

            <span class="information">{{ getComm }}</span>

            </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"> locales comerciales, (en lo sucesivo referido como </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><strong>&ldquo;EL PROYECTO&rdquo;</strong></span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">), el cual se describe en t&eacute;rminos generales en el documento adjunto al presente contrato como </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><strong>ANEXO "A"</strong></span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">, y que ser&aacute; comercialmente identificado como </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">&ldquo;</span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><strong>

              <span class="information">{{ dep.cluster.name }}</span>

               </strong></span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">&rdquo;</span></span><span style="font-family: Arial, serif;"><span style="font-size: small;">.</span></span></p>
        </li>
        </ol>

        <ol start="7" type="a">
        <li>
        <p align="JUSTIFY"><span style="font-family: Arial, serif;"><span style="font-size: small;">Entre las unidades habitacionales que integran EL PROYECTO, </span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><span lang="es-MX">se encuentra la identificada convencionalmente con el número </span></span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><span lang="es-MX">

          <span class="information">{{ dep.unitNumber }}</span>

          </span></span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><span lang="es-MX"> (en lo sucesivo </span></span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><span lang="es-MX"><strong>&ldquo;LA UNIDAD&rdquo;</strong></span></span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><span lang="es-MX">), en el entendido que dicha nomenclatura podr&aacute; variar atendiendo al determinado por las autoridades al formalizar el r&eacute;gimen de propiedad en condominio; cuyas dimensiones, acabados y caracter&iacute;sticas se describen en el </span></span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><span lang="es-MX"><strong>ANEXO &ldquo;A&rdquo;</strong></span></span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><span lang="es-MX">. </span></span></span></p>
        </li>
        </ol>
        <p lang="es-MX">&nbsp;</p>
        <ol start="8" type="a">
        ...
        <p lang="es-ES" align="JUSTIFY"><span style="font-family: Arial, serif;"><span style="font-size: small;"><span lang="es-ES">Que su domicilio para efectos del presente contrato es el ubicado en </span></span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><span lang="es-ES">
          ...
          <span class="information">{{ departmentContract.customer.email != null? departmentContract.customer.email : '-' }}</span>

          </span></span></span><span style="font-family: Arial, serif;"><span style="font-size: small;"><span lang="es-MX">.</span></span></span></p>
        </li>
        </ol>
        ...
        <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;">
          ...
          <p align="CENTER"><span style="font-family: Arial, serif;margin-left:10px;"><span style="font-size: small;">Representada por </span></span></p>
          ...
          <p align="CENTER"><span style="font-family: Arial, serif;margin-left:10px"><span style="font-size: small;"><span lang="es-MX">_________________</span></span></span></p>
          </td>
          </tr>
          </tbody>
          </table>
...
export default {
  props:['departmentContract','dep','getDeps','getComm'],
  mounted: function() {
    const CSScontract = `
    .information{
