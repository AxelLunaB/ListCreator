<template>
 <div class="willPrintContract" id="willPrintContract" style="margin:30px;z-index:9999;position: absolute;padding:30px;margin:0;top:0;">
   {{dep}}
        <p></p>
        ...
        <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;">
          ...
          <p align="CENTER"><span style="font-family: Arial, serif;margin-left:60px;"><span style="font-size: small;">Representada por </span></span></p>
...
export default {
mounted:function(){
    this.$eventHub.$on("contract-info", department => {
      department = this.dep
      alert(this.dep)
  });
},
