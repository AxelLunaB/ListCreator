       ...
       <div class="modal-content">
        <div class="card">
          <header class="modal-card-head">
            <p class="modal-card-title">{{house.cluster.name}} · #{{house.lotnumber}} <small>{{house.model}}</small></p>
            ...
            <form id="house-edit-form">
              ...
              <div class="columns is-mobile is-multiline">
                ...
                <div class="column is-half">
                  ...
                  <div v-if="isEdditing">
                    <input class="input" type="text" name="type" :value="house.type">
                  </div>
                </div>
                <div class="column is-half">
                  TERRENO M2
                ...
                <div class="column is-half">
                  ...
                  <div v-if="isEdditing">
                    <input class="input" type="text" name="terrainm2" :value="house.terrainm2">
                  </div>
                </div>
                <div class="column is-half">
                  Precio M2
                ...
                <div class="column is-half">
                  ...
                  <div v-if="isEdditing">
                    <input class="input" type="text" name="pricem2" :value="house.pricem2">
                  </div>
                </div>
                <div class="column is-half">
                  Precio total
                ...
                <div class="column is-half">
                  ...
                  <div v-if="isEdditing">
                    <input class="input" type="text" name="totalprice" :value="house.totalprice">
                  </div>
                </div>
                 <div class="column is-half">
                  Número Oficial
                ...
                <div class="column is-half">
                  ...
                  <div v-if="isEdditing">
                    <input class="input" type="text" name="officialnumber" :value="house.officialnumber">
                  </div>
                </div>
              </div>
            </form>
...
export default {
  props: [],
  mounted: function() {
    this.$eventHub.$on("show-house-detail-modal", house => {
      this.house = house;
      this.show = true;
    });
  },
  ...
  methods: {
    ...
    saveChanges(close) {
      ...
      this.$store
        .dispatch("houses/updateHouse", data)
        .then(response => {
          swal({
